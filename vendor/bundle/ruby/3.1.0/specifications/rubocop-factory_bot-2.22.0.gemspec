# -*- encoding: utf-8 -*-
# stub: rubocop-factory_bot 2.22.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2023-05-05"
  s.description = "    Code style checking for FactoryBot files.\n    A plugin for the RuboCop code style enforcing & linting tool.\n".freeze
  ...
  s.summary = "Code style checking for FactoryBot files".freeze
